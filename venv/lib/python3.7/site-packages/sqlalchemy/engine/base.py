...
class Connection(Connectable):
    ...
    def execution_options(self, **opt):
        ...
        is suitable for usage by end-users schemes to communicate with
        ...
        :param compiled_cache: Available on: Connection.
          ...
          It is the users's responsibility to
    ...
    def info(self):
        ...
        referred to by this :class:`.Connection`, allowing users-defined
