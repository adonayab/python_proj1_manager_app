...
using ``host`` as an additional keyword argument::
    ...
    create_engine("postgresql+psycopg2://users:password@/dbname?host=/var/lib/postgresql")
...
:func:`.create_engine` using the ``client_encoding`` parameter::
    ...
    engine = create_engine("postgresql://users:pass@host/dbname",
                           client_encoding='utf8')
...
using the :paramref:`.create_engine.connect_args` parameter::
    ...
    engine = create_engine(
        "postgresql://users:pass@host/dbname",
        connect_args={'client_encoding': 'utf8'})

    # using the query string is equivalent
    engine = create_engine("postgresql://users:pass@host/dbname?client_encoding=utf8")
...
class PGDialect_psycopg2(PGDialect):
    ...
    def create_connect_args(self, url):
        ...
        if opts:
            ...
            # send individual dbname, users, password, host, port
