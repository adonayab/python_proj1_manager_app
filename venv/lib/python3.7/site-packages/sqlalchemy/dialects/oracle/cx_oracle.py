...
.. dialect:: oracle+cx_oracle
    :name: cx-Oracle
    :dbapi: cx_oracle
    :connectstring: oracle+cx_oracle://users:pass@host:port/dbname[?key=value&key=value...]
...
``cx_Oracle.makedsn()`` function. The URL below::
    ...
    e = create_engine("oracle+cx_oracle://users:pass@hostname/dbname")
...
``events``, ``threaded``, and others::
    ...
    e = create_engine(
        "oracle+cx_oracle://users:pass@dsn?mode=SYSDBA&events=true")
...
such as::
    ...
    e = create_engine(
        "oracle+cx_oracle://users:pass@dsn", coerce_to_unicode=False)
