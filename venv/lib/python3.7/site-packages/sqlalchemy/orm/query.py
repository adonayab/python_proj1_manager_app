...
class Query(object):
    ...
    ORM, both those formulated by end-users query operations as well as by
    ...
    def _set_entities(self, entities, entity_wrapper=None):
        ...
        #    is an arbitrary callable in some users recipes, not
    ...
    def yield_per(self, count):
        ...
        .. warning::
            ...
            present in more than one batch of rows, end-users changes
    ...
    def from_self(self, *entities):
        ...
        .. sourcecode:: sql
            ...
            FROM (SELECT "users".id AS user_id, "users".name AS user_name
            FROM "users"
            WHERE "users".name LIKE :name_1) AS anon_1
        ...
        the set of users objects we query against, and then apply additional
        ...
        **Looking out for Inner / Outer Columns**
        ...
        the ``User`` columns::
            ...
            q = session.query(Address).join(Address.users).\
                filter(User.name.like('e%'))

            q = q.add_entity(User).from_self().\
                options(contains_eager(Address.users))
        ...
        join criteria - note the ``anon1, "users"`` phrase at
        the end:
        ...
        .. sourcecode:: sql
            ...
            FROM (
                ...
                address.user_id AS address_user_id
            FROM address JOIN "users" ON "users".id = address.user_id
            WHERE "users".name LIKE :name_1) AS anon_1, "users"
    ...
    def join(self, *props, **kwargs):
        ...
        **Simple Relationship Joins**
        ...
        will result in SQL equivalent to::
            ...
            SELECT users.* FROM users JOIN address ON users.id = address.user_id
        ...
        **Joins to a Target with an ON Clause**
        ...
        Where above, the generated SQL would be similar to::
            ...
            SELECT users.* FROM users
                ...
                JOIN address AS address_1 ON users.id=address_1.user_id
    ...
    def select_entity_from(self, from_obj):
        ...
        .. sourcecode:: sql
            ...
            FROM "users", (SELECT "users".id AS id, "users".name AS name
            FROM "users"
            WHERE "users".id = :id_1) AS anon_1
            WHERE "users".name = :name_1
        ...
        :meth:`.TextClause.columns` method::
            ...
            text_stmt = text("select id, name from users").columns(
                User.id, User.name)
        ...
        services.  Suppose
        a view ``user_view`` also returns rows from ``users``.    If
...
class AliasOption(interfaces.MapperOption):
    def __init__(self, alias):
        ...
        is being used in conjunction with a users-defined SELECT
