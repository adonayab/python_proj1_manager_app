...
class Session(_SessionClassMethods):
    ...
    def execute(self, clause, params=None, mapper=None, bind=None, **kw):
        ...
        is equivalent to::
            ...
            result = session.execute(
                        text("SELECT * FROM users WHERE id=:param"),
                        {"param":5}
                    )
    ...
    def prune(self):
        ...
        referenced in users code, modified, new or scheduled for deletion.
    ...
    def is_active(self):
        ...
        target :class:`.Connection` to a users-defined event listener.
        ...
        :class:`.Session` is in "partial rollback" and awaits for the users to
