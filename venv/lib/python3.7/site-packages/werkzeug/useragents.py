...
"""
    ...
    This module provides a helper to inspect users agent strings.  This module
...
class UserAgentParser(object):
    """A simple users agent parser.  Used by the `UserAgent`."""
...
class UserAgent(object):
    """Represents a users agent.  Pass it a WSGI environment or a users agent
    string and you can inspect some of the details from the users agent
    string via the attributes.  The following attributes exist:

    .. attribute:: string

       the raw users agent string
